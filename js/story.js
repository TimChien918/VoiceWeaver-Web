...
import { t } from "./i18n.js?v=1.5.27";
import { STORY_PROMPTS, pickLang } from "./storydata.js?v=1.5.27";
import { reviewStory } from "./llm.js?v=1.5.27";
import { speak, listen, sttSupported } from "./speech.js?v=1.5.27";
import { addRehabLog } from "./store.js?v=1.5.27";
