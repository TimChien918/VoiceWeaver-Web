...
import { speak, listen, sttSupported } from "./speech.js?v=1.5.67";
import { scoreRehab, suggestRehab, hasAnyLlmKey } from "./llm.js?v=1.5.67";
import { addRehabLog, listRehabLogs } from "./store.js?v=1.5.67";
import { t as tr } from "./i18n.js?v=1.5.67";
