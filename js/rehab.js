...
import { scoreRehab, suggestRehab, hasAnyLlmKey } from "./llm.js?v=1.4.1";
import { addRehabLog, listRehabLogs } from "./store.js?v=1.4.1";
import { t as tr } from "./i18n.js?v=1.4.1";
