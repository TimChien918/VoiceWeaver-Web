...
import { AAC_CATS, CAT_EMOJI, cardsOfCat, allCards, searchCards, CURRENCIES } from "./aac.js?v=1.5.31";
import { feed as rankFeed, rankWithin, recordUse, activeItemCount } from "./aacrank.js?v=1.5.31";
import { setupKiosk, enterKiosk } from "./kiosk.js?v=1.5.31";
import { bindTap } from "./interaction.js?v=1.5.31";
import { orderCards } from "./predict.js?v=1.5.31";
import { CLINICAL_BANK, practiceItem } from "./clinical.js?v=1.5.31";
import { markFirstSpeak, recordCandidateChoice, recordUndo, recordInputSource } from "./behavior.js?v=1.5.31";
import { openCrisis, setupCrisis } from "./crisis.js?v=1.5.31";
import { classifyRisk, containsCrisisSignal } from "./safety.js?v=1.5.31";
import { preloadZhConv, toTraditionalSync } from "./zhconv.js?v=1.5.31";
import { setupStory, renderStory, setStoryToast } from "./story.js?v=1.5.31";
import { setupHeadControl, stopHeadControl } from "./headcontrol.js?v=1.5.31";
import { startAudioCapture, stopAndInterpret, cancelAudioCapture, isRecording, hasNativeAudio } from "./audiodirect.js?v=1.5.31";
import { generateImage, intentPrompt, detectLocation, recognizePhoto, telegramNotify } from "./extras.js?v=1.5.31";
import { setupRehab, renderRehabLogs, setRehabToast } from "./rehab.js?v=1.5.31";
import { setupReport, loadReport, setReportToast } from "./report.js?v=1.5.31";
import { detectLocalTts, localVoices, localSwitch, localCatalog, localPrepare, localComputeEnabled } from "./localtts.js?v=1.5.31";
import * as Acoustic from "./acoustic.js?v=1.5.31";
import * as Mic from "./acousticmic.js?v=1.5.31";
import { applyI18n, t } from "./i18n.js?v=1.5.31";
import { setupDemo } from "./demo.js?v=1.5.31";
...
async function renderVoices(){
  ...
  if(!list.length){
    ...
    try{
      const drive = await import("./drive.js?v=1.5.31");
