import { state, newId, initAuth, loginGoogle, loginAnon, logout, save, addHistory, listHistory, toggleFavorite, ensurePairCode, pushNgrokBridge, listShortcuts, saveShortcut, deleteShortcut, listVoices, reauthorizeDrive, needsDriveReauth, isBenignAuthError, accountEmail, switchAccount, needsScopeUpgrade, listAcousticRecordings, saveAcousticRecording } from "./store.js?v=1.5.39";
import { LLM_PROVIDERS, IMAGE_PROVIDERS } from "./providers.js?v=1.5.39";
import { reconstruct, composeAac, hasAnyLlmKey, classifyCrisisIntent } from "./llm.js?v=1.5.39";
import { speak, speakNow, speakIn, listen, sttSupported, setSpeechToast } from "./speech.js?v=1.5.39";
import { AAC_CATS, CAT_EMOJI, cardsOfCat, allCards, searchCards, CURRENCIES } from "./aac.js?v=1.5.39";
import { feed as rankFeed, rankWithin, recordUse, activeItemCount } from "./aacrank.js?v=1.5.39";
import { setupKiosk, enterKiosk } from "./kiosk.js?v=1.5.39";
import { bindTap } from "./interaction.js?v=1.5.39";
import { orderCards } from "./predict.js?v=1.5.39";
import { CLINICAL_BANK, practiceItem } from "./clinical.js?v=1.5.39";
import { markFirstSpeak, recordCandidateChoice, recordUndo, recordInputSource } from "./behavior.js?v=1.5.39";
import { openCrisis, setupCrisis } from "./crisis.js?v=1.5.39";
import { classifyRisk, containsCrisisSignal } from "./safety.js?v=1.5.39";
import { preloadZhConv, toTraditionalSync } from "./zhconv.js?v=1.5.39";
import { setupStory, renderStory, setStoryToast } from "./story.js?v=1.5.39";
import { setupHeadControl, stopHeadControl } from "./headcontrol.js?v=1.5.39";
import { startAudioCapture, stopAndInterpret, cancelAudioCapture, isRecording, hasNativeAudio } from "./audiodirect.js?v=1.5.39";
import { generateImage, intentPrompt, detectLocation, recognizePhoto, telegramNotify } from "./extras.js?v=1.5.39";
import { setupRehab, renderRehabLogs, setRehabToast } from "./rehab.js?v=1.5.39";
import { setupReport, loadReport, setReportToast } from "./report.js?v=1.5.39";
import { detectLocalTts, localVoices, localSwitch, localCatalog, localPrepare, localComputeEnabled } from "./localtts.js?v=1.5.39";
import * as Acoustic from "./acoustic.js?v=1.5.39";
import * as Mic from "./acousticmic.js?v=1.5.39";
import { applyI18n, t } from "./i18n.js?v=1.5.39";
import { setupDemo } from "./demo.js?v=1.5.39";
...
async function renderVoices(){
  ...
  if(!list.length){
    ...
    try{
      const drive = await import("./drive.js?v=1.5.39");
