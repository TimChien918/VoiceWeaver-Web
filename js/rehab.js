...
import { scoreRehab, suggestRehab, hasAnyLlmKey } from "./llm.js?v=1.5.25";
import { addRehabLog, listRehabLogs } from "./store.js?v=1.5.25";
import { t as tr } from "./i18n.js?v=1.5.25";
