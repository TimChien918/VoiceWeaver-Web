...
import { runLlm, hasLlm } from "./providers.js?v=1.5.39";
import { t as tr } from "./i18n.js?v=1.5.39";   // 別名：下方備援區塊有局部變數 t，避免遮蔽
import { DEFENSIVE_SYSTEM_PROMPT } from "./safety.js?v=1.5.39";
import { toTraditionalSync } from "./zhconv.js?v=1.5.39";
