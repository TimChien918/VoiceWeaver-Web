...
import { localHas, localText, localImage } from "./localtts.js?v=1.5.70";
import { sharedEntries, countSharedUse } from "./shared.js?v=1.5.70";
import { webgpuUsable, webgpuGenerate } from "./webgpu.js?v=1.5.70";
