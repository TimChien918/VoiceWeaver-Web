...
import { state } from "./store.js?v=1.5.10";
import { localTtsEnabled, localSpeak, stopLocalSpeak } from "./localtts.js?v=1.5.10";
import { t } from "./i18n.js?v=1.5.10";
import { sanitizeForSpeech } from "./safety.js?v=1.5.10";
