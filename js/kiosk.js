...
import { state, save } from "./store.js?v=1.5.11";
import { speakUpbeat } from "./speech.js?v=1.5.11";
import { severeCore } from "./aac.js?v=1.5.11";
import { bindTap } from "./interaction.js?v=1.5.11";   // 共用觸控防呆（pointerup + 防連點 + 禁長按）
