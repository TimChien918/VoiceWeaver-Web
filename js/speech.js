...
import { state } from "./store.js?v=1.5.47";
import { localTtsEnabled, localSpeak, stopLocalSpeak } from "./localtts.js?v=1.5.47";
import { t } from "./i18n.js?v=1.5.47";
import { sanitizeForSpeech } from "./safety.js?v=1.5.47";
